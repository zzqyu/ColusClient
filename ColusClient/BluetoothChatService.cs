...
namespace ColusClient
{
    ...
    public class BluetoothChatService
    {
        ...
        private static UUID MY_UUID_SECURE = UUID.FromString("00000003-0000-1000-8000-00805f9b34fb");
        private static UUID MY_UUID_INSECURE = UUID.FromString("00000003-0000-1000-8000-00805f9b34fb");

        //private static UUID MY_UUID_SECURE , MY_UUID_INSECURE;

        private string MY_UUID = "00000003-0000-1000-8000-00805f9b";
