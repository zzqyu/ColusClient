...
{
    public class ItemFiveFragment : BChatFragment
    {
        ...
        public ItemFiveFragment(BluetoothChatService bcs) : base(bcs)
        {

        }

        public static ItemFiveFragment NewInstance(BluetoothChatService bcs)
        {
            ItemFiveFragment fragment = new ItemFiveFragment(bcs);
            return fragment;
        }
        ...
        {
            return inflater.Inflate(Resource.Layout.fragment_item_five, container, false);
        }
